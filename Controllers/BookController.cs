...
namespace LMS.Controllers
{
    public class BookController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Bookid,Title,Authorid,Genre,Publishedyear,Isbn")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Bookid,Title,Authorid,Genre,Publishedyear,Isbn")] Book book)
        {
            if (id != book.Bookid)
            {
                return NotFound();
